...
require (
	...
	github.com/jimsnab/go-treestore v0.0.0-20231109153034-6f495c4c31ef
	github.com/jimsnab/go-treestore-cmdline v0.0.0-20231109153107-417724967a70
)
...
require (
	...
	github.com/jimsnab/go-cmdline v1.4.1 // indirect
