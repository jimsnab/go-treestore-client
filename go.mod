...
require (
	...
	github.com/jimsnab/go-treestore v0.0.0-20230912202938-3174246176e6
	github.com/jimsnab/go-treestore-cmdline v0.0.0-20230912203139-b184cc4e4452
)
...
require (
	...
	github.com/jimsnab/go-cmdline v1.2.0 // indirect
